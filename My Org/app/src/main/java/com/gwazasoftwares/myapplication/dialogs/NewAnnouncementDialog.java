...
public class NewAnnouncementDialog extends AppCompatDialogFragment {
                ...
                .setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(TextUtils.isEmpty(announcement_tv.getText())){
                            Toast.makeText(getActivity(), "please write your announcement ",Toast.LENGTH_SHORT).show();
                        }
                        Announcement my_announcement = new Announcement(announcement_tv.getText().toString());

                        refference.child("standau").child("announcements").push().setValue(my_announcement);
